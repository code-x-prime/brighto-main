...
const INJECTED_STYLES = `
  ...
  .premium-depth-card {
      background: linear-gradient(145deg, #0B1F66 0%, #050914 100%);
      box-shadow: 
...
export function CinematicHero({ 
  brandName = "BRIGHTO",
  tagline1 = "Verification Intelligence,",
  tagline2 = "built for enterprises.",
  cardHeading = "Trust & compliance, automated.",
  cardDescription = <><span className="text-white font-semibold">Brighto India</span> empowers banks, NBFCs, and fintechs with structured identity verification, background screening, and geo-tagged CPV workflows.</>,
  metricValue = 99,
  metricLabel = "% Accuracy",
  ctaHeading = "Accelerate onboarding.",
  ctaDescription = "Join hundreds of banks, NBFCs and fintechs using our RBI-compliant APIs and risk controls today.",
  className, 
  ...props 
}: CinematicHeroProps) {
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <Link href="/contact" aria-label="Schedule a Demo" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Book a Custom</div>
              <div className="text-xl font-bold leading-none tracking-tight">Enterprise Demo</div>
            </div>
          </Link>
          <Link href="/services" aria-label="Explore Solutions" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">View All Verification</div>
              <div className="text-xl font-bold leading-none tracking-tight">Our Solutions</div>
            </div>
          </Link>
        </div>
      </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                >
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="absolute top-[5px] left-1/2 -translate-x-1/2 w-[100px] h-[28px] bg-black rounded-full z-50 flex items-center justify-end px-3 shadow-[inset_0_-1px_2px_rgba(255,255,255,0.1)]">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#F97316] shadow-[0_0_8px_rgba(249,115,22,0.8)] animate-pulse" />
                    </div>
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Live Feed</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Risk Monitor</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">BV</div>
                      </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
                          ...
                          <circle className="progress-ring" cx="88" cy="88" r="64" fill="none" stroke="#F97316" strokeWidth="12" />
                        </svg>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500/20 to-orange-600/5 flex items-center justify-center mr-3 border border-orange-400/20 shadow-inner">
                            <svg className="w-4 h-4 text-[#F97316] drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">RBI Compliant</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">100% verified status</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Instant TAT</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Under 2 minutes</p>
                  </div>
                </div>
