...
import { IconDownload, IconTrash, IconEye, IconExternalLink, IconMail, IconPhone, IconFileText, IconSearch, IconUser } from '@tabler/icons-react'
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-zinc-200 py-20 text-center">
          <IconFileText className="w-10 h-10 text-zinc-300 mx-auto mb-3" />
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-zinc-500 flex items-center gap-1">
                            <IconMail className="w-3 h-3" /> {app.email}
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <a
                          ...
                          title="Open Resume"
                        >
                          <IconExternalLink className="w-4 h-4 text-zinc-600" />
                        </a>
                        <button
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-zinc-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-zinc-900 flex items-center gap-1">
                    <IconPhone className="w-3.5 h-3.5" /> {selectedApp.phone}
                  </p>
                </div>
                <div className="bg-zinc-50 rounded-lg p-3">
