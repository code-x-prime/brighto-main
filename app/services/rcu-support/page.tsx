...
const RCU_SERVICES = [
  { icon: 'Search',       title: 'Field Investigation Support',   desc: 'Support information validation requirements through organized field visits and structured reporting procedures.',                               color: '#091C8C', bg: '#eef2ff', border: '#c7d2fe' },
  ...
  { icon: 'Home',         title: 'Residence Verification',        desc: 'Confirm the residential address through structured verification steps that support review and assessment work.',                                    color: '#0369a1', bg: '#f0f9ff', border: '#bae6fd' },
  { icon: 'Briefcase',    title: 'Office Verification',           desc: 'Verify the existence, occupancy, and operational status of an office or business location through structured field checks and documented observations.', color: '#059669', bg: '#f0fdf4', border: '#a7f3d0' },
  { icon: 'Building2',    title: 'Business Verification',         desc: 'Validate business details through structured verification and investigation activities.',                                                           color: '#d97706', bg: '#fffbeb', border: '#fde68a' },
  { icon: 'CheckCircle2', title: 'Information Validation Support', desc: 'Strengthen review systems through structured information validation and assessment support services.',                                   color: '#7c3aed', bg: '#faf5ff', border: '#ddd6fe' },
  ...
  { icon: 'FileCheck',    title: 'Verification Reporting',        desc: 'Receive structured reports documenting verification findings and supporting information for client review.',                                                                color: '#4f46e5', bg: '#eef2ff', border: '#c7d2fe' },
]
...
const WHY_MATTERS = [
  { title: 'Improve Information Visibility',   desc: 'Independent verification steps give financial institutions a clearer view of the details that need review.' },
  { title: 'Strengthen Review Frameworks',      desc: 'Planned RCU support leads to more consistent verification and assessment outcomes.' },
  { title: 'Support Risk Assessment Activities',desc: 'Verification findings and documented observations support internal review and evaluation processes.' },
  { title: 'Enhance Information Validation',    desc: 'Independent investigations corroborate the details submitted during operational and loan review processes.' },
  { title: 'Improve Operational Consistency',   desc: 'Defined methodologies keep review, verification, and reporting steps consistent across the board.' },
]

const WHY_BRIGHTO = [
  { title: 'Financial Services Expertise',          desc: 'Brighto India supports banks, NBFCs, housing finance companies, fintech organizations, and other financial institutions with specialized verification and investigation services.' },
  ...
  { title: 'Experienced Verification Network',       desc: 'We combine operational expertise with field investigation capabilities across multiple locations.' },
  { title: 'Secure & Compliance-Focused Operations', desc: 'Our processes are supported by established data security standards, quality controls, and operational safeguards.' },
  { title: 'Structured Reporting Framework',         desc: 'Verification findings are documented in structured report formats that support internal review processes.' },
  { title: 'Pan-India Operational Reach',            desc: 'Our operational network enables verification support across multiple geographies and business environments.' },
]

const INDUSTRIES = [
  { svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" /></svg>, label: 'Banking', desc: 'Verification and investigation support for loan and customer review processes.' },
  { svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" /></svg>, label: 'NBFCs', desc: 'Structured RCU support services aligned with lending and operational review requirements.' },
  { svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>, label: 'Housing Finance Companies', desc: 'Data confirmation and investigation support for housing loan review workflows.' },
  { svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 19.5V21M12 3v1.5m0 15V21m3.75-18v1.5m0 15V21m-9-1.5h10.5a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25H6.75A2.25 2.25 0 004.5 6.75v10.5a2.25 2.25 0 002.25 2.25zm.75-12h9v9h-9v-9z" /></svg>, label: 'Fintech Companies', desc: 'Verification services supporting digital lending and customer review processes.' },
...
const PROCESS_STEPS = [
  ...
  { num: '05', svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>, title: 'Assessment & Documentation', desc: 'Compiling observations, supporting evidence, and investigation results.' },
  { num: '06', svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg>, title: 'Reporting', desc: 'Providing structured reports for client review and evaluation.' },
]

const FAQS = [
  { q: 'What is Risk Containment Unit (RCU) Support?', a: 'RCU Support covers structured verification, investigation, and information validation activities that support financial institutions during risk review and assessment.' },
  { q: 'Which organizations use RCU Support Services?', a: 'Banks, NBFCs, housing finance companies, fintech organizations, and other financial institutions commonly use RCU support services.' },
  ...
  { q: 'Does Brighto India provide field investigation services?', a: 'Yes. Brighto India provides field investigation and verification support services designed to assist organizations in their review and assessment processes.' },
  ...
  { q: 'Does Brighto India offer pan-India RCU Support?', a: 'Yes. Brighto India fulfills verification and investigation requirements across multiple locations through its operational network.' },
  { q: "How can I get started with Brighto India's RCU Support Services?", a: 'Reach out to our team to discuss your verification requirements, assessment goals, and operational requirements. We will recommend an appropriate support plan aligned with your engagement scope.' },
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            <div className="lg:col-span-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-slate-600 leading-relaxed text-base">
                <p>Since 2015, Brighto India has worked with banks, NBFCs, housing finance companies, fintech companies, and other financial institutions by providing structured Risk Containment Unit (RCU) Support Services that improve risk review and assessment processes.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="flex flex-col gap-8">
              <div>
                ...
                <div className="space-y-4 text-slate-600 leading-relaxed">
                  ...
                  <p>Whether working with banks, NBFCs, housing finance companies, fintech lenders, or other financial institutions, our team delivers process-oriented RCU support tailored to operational requirements.</p>
                </div>
              </div>
            ...
            <div className="bg-slate-950 rounded-3xl p-8 lg:p-10">
              ...
              <div className="space-y-3 text-slate-400 text-sm leading-relaxed mb-8">
                <p>Risk Containment Unit (RCU) Support refers to structured verification, investigation, and information validation activities that assist financial institutions through the risk review and assessment process.</p>
                ...
                <p>These steps help financial institutions strengthen their review methods and support decisions with verified data.</p>
              </div>
      ...
      <section className="py-24 bg-blue-900 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-blue-200 text-lg leading-relaxed mb-10">
            Whether you need field investigation support, residence verification, office verification, business verification, exception case reviews, or information validation services, our team can recommend a structured approach aligned with your operational requirements.
          </p>
