...
const industries = [
  ...
  { name: "MNCs & Enterprises", icon: '/icons/housing-finance.svg', accent: "#14B8A6", desc: "Background screening, employment verification, and contractor checks for workforce compliance." },
  ...
  { name: 'Staffing & Recruitment', icon: '/icons/staffing-recruitment.svg', accent: '#6366F1', desc: 'Background screening, employment verification, and contractor checks for workforce compliance.' },
  { name: 'Stock / Warehouse Audit (Commodity Finance)', icon: '/icons/commodity-finance.svg', accent: '#F59E0B', desc: 'Warehouse audits, stock verification, and collateral reviews for commodity finance lenders.' },
    ...
    <section id="industries" className="py-12 lg:py-16 bg-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative border border-slate-800 rounded-2xl overflow-hidden">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 border-slate-800">
