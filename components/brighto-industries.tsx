...
const industries = [
  ...
  { name: "MNC", icon: '/icons/housing-finance.svg', accent: "#14B8A6", desc: "Background screening, employment verification, and contractor checks for workforce compliance." },
