...
export function BrightoTrustNetwork() {
  const brands = [
    { name: 'Crediscout', initials: 'CS', desc: 'Field verification & CPV platform', logo: '/CrediScout-Logo2.png', url: 'https://crediscout.in' },
    ...
    { name: 'Credify India', initials: 'CI', desc: 'Background verification and API solution', logo: '/Credify-Logo2.png', url: 'https://credifyindia.com' },
